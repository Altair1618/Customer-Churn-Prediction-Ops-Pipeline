...
with DAG(dag_id='drift_detection_dag', start_date=days_ago(0), schedule_interval='@daily') as dag:
...
with DAG(dag_id='drift_simulator_dag', start_date=days_ago(0) , schedule_interval='@daily') as dag:
